...
window.MSX_DATA = {
  ...
  groups: [
    ...
    { id: 2,  key: "video",     label: "Video",         order: 3 },
    { id: 3,  key: "audio",     label: "Audio",         order: 4 },
    { id: 4,  key: "media",     label: "Media",         order: 5 },
    { id: 5,  key: "cpu",       label: "CPU/Chipsets",  order: 6 },
    { id: 6,  key: "other",     label: "Other",         order: 7 },
    { id: 7,  key: "emulation", label: "Emulation",     order: 8 }
  ],
  columns: [
    ...
    { id:  5, key: "standard",         label: "Generation",         shortLabel: "Gen",            groupId: 12, type: "string" },
    { id:  6, key: "form_factor",      label: "Form Factor",        groupId: 12, type: "string" },
