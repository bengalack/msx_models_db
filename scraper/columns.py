...
COLUMNS: list[Column] = [
    ...
    Column(id=30, key="slotmap_0_0_0", label="0-0/0", group="slotmap_0", type="string"),
    Column(id=31, key="slotmap_0_0_1", label="0-0/1", group="slotmap_0", type="string"),
    Column(id=32, key="slotmap_0_0_2", label="0-0/2", group="slotmap_0", type="string"),
    Column(id=33, key="slotmap_0_0_3", label="0-0/3", group="slotmap_0", type="string"),
    Column(id=34, key="slotmap_0_1_0", label="0-1/0", group="slotmap_0", type="string"),
    Column(id=35, key="slotmap_0_1_1", label="0-1/1", group="slotmap_0", type="string"),
    Column(id=36, key="slotmap_0_1_2", label="0-1/2", group="slotmap_0", type="string"),
    Column(id=37, key="slotmap_0_1_3", label="0-1/3", group="slotmap_0", type="string"),
    Column(id=38, key="slotmap_0_2_0", label="0-2/0", group="slotmap_0", type="string"),
    Column(id=39, key="slotmap_0_2_1", label="0-2/1", group="slotmap_0", type="string"),
    Column(id=40, key="slotmap_0_2_2", label="0-2/2", group="slotmap_0", type="string"),
    Column(id=41, key="slotmap_0_2_3", label="0-2/3", group="slotmap_0", type="string"),
    Column(id=42, key="slotmap_0_3_0", label="0-3/0", group="slotmap_0", type="string"),
    Column(id=43, key="slotmap_0_3_1", label="0-3/1", group="slotmap_0", type="string"),
    Column(id=44, key="slotmap_0_3_2", label="0-3/2", group="slotmap_0", type="string"),
    Column(id=45, key="slotmap_0_3_3", label="0-3/3", group="slotmap_0", type="string"),

    # Slotmap, slot 1  (IDs 46–61)  — ms=1, ss=0..3, p=0..3
    Column(id=46, key="slotmap_1_0_0", label="1-0/0", group="slotmap_1", type="string"),
    Column(id=47, key="slotmap_1_0_1", label="1-0/1", group="slotmap_1", type="string"),
    Column(id=48, key="slotmap_1_0_2", label="1-0/2", group="slotmap_1", type="string"),
    Column(id=49, key="slotmap_1_0_3", label="1-0/3", group="slotmap_1", type="string"),
    Column(id=50, key="slotmap_1_1_0", label="1-1/0", group="slotmap_1", type="string"),
    Column(id=51, key="slotmap_1_1_1", label="1-1/1", group="slotmap_1", type="string"),
    Column(id=52, key="slotmap_1_1_2", label="1-1/2", group="slotmap_1", type="string"),
    Column(id=53, key="slotmap_1_1_3", label="1-1/3", group="slotmap_1", type="string"),
    Column(id=54, key="slotmap_1_2_0", label="1-2/0", group="slotmap_1", type="string"),
    Column(id=55, key="slotmap_1_2_1", label="1-2/1", group="slotmap_1", type="string"),
    Column(id=56, key="slotmap_1_2_2", label="1-2/2", group="slotmap_1", type="string"),
    Column(id=57, key="slotmap_1_2_3", label="1-2/3", group="slotmap_1", type="string"),
    Column(id=58, key="slotmap_1_3_0", label="1-3/0", group="slotmap_1", type="string"),
    Column(id=59, key="slotmap_1_3_1", label="1-3/1", group="slotmap_1", type="string"),
    Column(id=60, key="slotmap_1_3_2", label="1-3/2", group="slotmap_1", type="string"),
    Column(id=61, key="slotmap_1_3_3", label="1-3/3", group="slotmap_1", type="string"),

    # Slotmap, slot 2  (IDs 62–77)  — ms=2, ss=0..3, p=0..3
    Column(id=62, key="slotmap_2_0_0", label="2-0/0", group="slotmap_2", type="string"),
    Column(id=63, key="slotmap_2_0_1", label="2-0/1", group="slotmap_2", type="string"),
    Column(id=64, key="slotmap_2_0_2", label="2-0/2", group="slotmap_2", type="string"),
    Column(id=65, key="slotmap_2_0_3", label="2-0/3", group="slotmap_2", type="string"),
    Column(id=66, key="slotmap_2_1_0", label="2-1/0", group="slotmap_2", type="string"),
    Column(id=67, key="slotmap_2_1_1", label="2-1/1", group="slotmap_2", type="string"),
    Column(id=68, key="slotmap_2_1_2", label="2-1/2", group="slotmap_2", type="string"),
    Column(id=69, key="slotmap_2_1_3", label="2-1/3", group="slotmap_2", type="string"),
    Column(id=70, key="slotmap_2_2_0", label="2-2/0", group="slotmap_2", type="string"),
    Column(id=71, key="slotmap_2_2_1", label="2-2/1", group="slotmap_2", type="string"),
    Column(id=72, key="slotmap_2_2_2", label="2-2/2", group="slotmap_2", type="string"),
    Column(id=73, key="slotmap_2_2_3", label="2-2/3", group="slotmap_2", type="string"),
    Column(id=74, key="slotmap_2_3_0", label="2-3/0", group="slotmap_2", type="string"),
    Column(id=75, key="slotmap_2_3_1", label="2-3/1", group="slotmap_2", type="string"),
    Column(id=76, key="slotmap_2_3_2", label="2-3/2", group="slotmap_2", type="string"),
    Column(id=77, key="slotmap_2_3_3", label="2-3/3", group="slotmap_2", type="string"),

    # Slotmap, slot 3  (IDs 78–93)  — ms=3, ss=0..3, p=0..3
    Column(id=78, key="slotmap_3_0_0", label="3-0/0", group="slotmap_3", type="string"),
    Column(id=79, key="slotmap_3_0_1", label="3-0/1", group="slotmap_3", type="string"),
    Column(id=80, key="slotmap_3_0_2", label="3-0/2", group="slotmap_3", type="string"),
    Column(id=81, key="slotmap_3_0_3", label="3-0/3", group="slotmap_3", type="string"),
    Column(id=82, key="slotmap_3_1_0", label="3-1/0", group="slotmap_3", type="string"),
    Column(id=83, key="slotmap_3_1_1", label="3-1/1", group="slotmap_3", type="string"),
    Column(id=84, key="slotmap_3_1_2", label="3-1/2", group="slotmap_3", type="string"),
    Column(id=85, key="slotmap_3_1_3", label="3-1/3", group="slotmap_3", type="string"),
    Column(id=86, key="slotmap_3_2_0", label="3-2/0", group="slotmap_3", type="string"),
    Column(id=87, key="slotmap_3_2_1", label="3-2/1", group="slotmap_3", type="string"),
    Column(id=88, key="slotmap_3_2_2", label="3-2/2", group="slotmap_3", type="string"),
    Column(id=89, key="slotmap_3_2_3", label="3-2/3", group="slotmap_3", type="string"),
    Column(id=90, key="slotmap_3_3_0", label="3-3/0", group="slotmap_3", type="string"),
    Column(id=91, key="slotmap_3_3_1", label="3-3/1", group="slotmap_3", type="string"),
    Column(id=92, key="slotmap_3_3_2", label="3-3/2", group="slotmap_3", type="string"),
    Column(id=93, key="slotmap_3_3_3", label="3-3/3", group="slotmap_3", type="string"),
]
