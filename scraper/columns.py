...
COLUMNS: list[Column] = [
    ...
    Column(id=34, key="slotmap_0_1_0", label="1 / P0", group="slotmap_0", type="string", shaded=True),
    Column(id=35, key="slotmap_0_1_1", label="1 / P1", group="slotmap_0", type="string", shaded=True),
    Column(id=36, key="slotmap_0_1_2", label="1 / P2", group="slotmap_0", type="string", shaded=True),
    Column(id=37, key="slotmap_0_1_3", label="1 / P3", group="slotmap_0", type="string", shaded=True),
    ...
    Column(id=42, key="slotmap_0_3_0", label="3 / P0", group="slotmap_0", type="string", shaded=True),
    Column(id=43, key="slotmap_0_3_1", label="3 / P1", group="slotmap_0", type="string", shaded=True),
    ...
    Column(id=50, key="slotmap_1_1_0", label="1 / P0", group="slotmap_1", type="string", shaded=True),
    Column(id=51, key="slotmap_1_1_1", label="1 / P1", group="slotmap_1", type="string", shaded=True),
    Column(id=52, key="slotmap_1_1_2", label="1 / P2", group="slotmap_1", type="string", shaded=True),
    Column(id=53, key="slotmap_1_1_3", label="1 / P3", group="slotmap_1", type="string", shaded=True),
    ...
    Column(id=58, key="slotmap_1_3_0", label="3 / P0", group="slotmap_1", type="string", shaded=True),
    Column(id=59, key="slotmap_1_3_1", label="3 / P1", group="slotmap_1", type="string", shaded=True),
    ...
    Column(id=66, key="slotmap_2_1_0", label="1 / P0", group="slotmap_2", type="string", shaded=True),
    Column(id=67, key="slotmap_2_1_1", label="1 / P1", group="slotmap_2", type="string", shaded=True),
    Column(id=68, key="slotmap_2_1_2", label="1 / P2", group="slotmap_2", type="string", shaded=True),
    Column(id=69, key="slotmap_2_1_3", label="1 / P3", group="slotmap_2", type="string", shaded=True),
    ...
    Column(id=74, key="slotmap_2_3_0", label="3 / P0", group="slotmap_2", type="string", shaded=True),
    Column(id=75, key="slotmap_2_3_1", label="3 / P1", group="slotmap_2", type="string", shaded=True),
    ...
    Column(id=82, key="slotmap_3_1_0", label="1 / P0", group="slotmap_3", type="string", shaded=True),
    Column(id=83, key="slotmap_3_1_1", label="1 / P1", group="slotmap_3", type="string", shaded=True),
    Column(id=84, key="slotmap_3_1_2", label="1 / P2", group="slotmap_3", type="string", shaded=True),
    Column(id=85, key="slotmap_3_1_3", label="1 / P3", group="slotmap_3", type="string", shaded=True),
    ...
    Column(id=90, key="slotmap_3_3_0", label="3 / P0", group="slotmap_3", type="string", shaded=True),
    Column(id=91, key="slotmap_3_3_1", label="3 / P1", group="slotmap_3", type="string", shaded=True),
    Column(id=92, key="slotmap_3_3_2", label="3 / P2", group="slotmap_3", type="string", shaded=True),
    Column(id=93, key="slotmap_3_3_3", label="3 / P3", group="slotmap_3", type="string", shaded=True),
]
